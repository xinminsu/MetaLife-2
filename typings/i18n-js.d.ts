...
declare module 'i18n-js' {
  type Key =
    ...
    | 'wallet.title'
    | 'wallet.mnemonic.title'
    | 'wallet.mnemonic.create.label'
    | 'wallet.mnemonic.create.accessibility_label'
    | 'wallet.mnemonic.process.label'
    | 'wallet.mnemonic.process.accessibility_label'
    | 'content.app_name'
    | 'content.tab_headers.home'
    | 'content.tab_headers.messages'
    | 'content.tab_headers.contacts'
    | 'content.tab_headers.discover'
    | 'content.tab_headers.profiles'
    | 'content.tab_footers.home'
    | 'content.tab_footers.messages'
    | 'content.tab_footers.contacts'
    | 'content.tab_footers.discover'
    | 'content.tab_footers.profiles'
    | 'content.loading'
    | 'content.building_indexes'
    | 'content.tabs.home.accessibility_label'
    | 'content.tabs.messages.accessibility_label'
    | 'content.tabs.contacts.accessibility_label'
    | 'content.tabs.discover.accessibility_label'
    | 'content.tabs.profiles.accessibility_label'
    | 'home.floating_action_button.compose'
    | 'home.empty.title'
